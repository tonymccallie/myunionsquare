<div class="admin_header">
	<h3>
		<i class="icon-edit"></i> Edit Announcement
		<div class="btn-group pull-right">
			<?php echo $this->Html->link('<i class="icon-trash"></i> ', array('action' => 'delete', $this->data['News']['id']), array('escape'=>false,'class'=>'btn'),'Are you sure you want to delete this announcement?'); ?>
		</div>
	</h3>
</div>
<div>
