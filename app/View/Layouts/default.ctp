...
<body class="">
	<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="left_col">
				<?php if($loggedIn): ?>
					<div id="self_picture"><?php echo !empty($USER['User']['photo'])?$this->Html->image('/images/thumb/'.$USER['User']['photo'].'/width:200/height:200/crop:true/zoom:auto',array('class'=>'img-circle')):'' ?></div>
