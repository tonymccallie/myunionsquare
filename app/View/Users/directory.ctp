...
<div class="directory">
	<div class="input-append pull-right">
		<?php
			echo $this->Form->create();
				echo $this->Form->input('department',array('div'=>false, 'class'=>'','label'=>false,'options'=>$departments));
	...
	<table class="table table-striped table-bordered">
		...
		<?php foreach($users as $user): ?>
			<tr>
				<td>
					<?php echo !empty($user['User']['photo'])?$this->Html->image('/images/thumb/'.$user['User']['photo'].'/width:200/height:200/crop:true/zoom:auto',array('class'=>'img-circle')):'' ?>
				</td>
